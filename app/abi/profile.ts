export const profileAbi = [
  ...
  { inputs: [], name: "ERC725X_ContractDeploymentFailed", type: "error" },
  {
    inputs: [],
    name: "ERC725X_CreateOperationsRequireEmptyRecipientAddress",
    type: "error",
  },
  { inputs: [], name: "ERC725X_ExecuteParametersEmptyArray", type: "error" },
  {
    inputs: [],
  ...
  { inputs: [], name: "ERC725X_NoContractBytecodeProvided", type: "error" },
  {
    inputs: [
      {
  ...
  { inputs: [], name: "LSP14CannotTransferOwnershipToSelf", type: "error" },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: "universalReceiver",
    outputs: [{ internalType: "bytes", name: "returnedValues", type: "bytes" }],
    stateMutability: "payable",
    type: "function",
  },
